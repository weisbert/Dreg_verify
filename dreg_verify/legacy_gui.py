# -*- coding: utf-8 -*-
"""
legacy_gui.py — v1 旧门面（已退役，保留到 v2 真表验收通过；运行 `python -m dreg_verify.legacy_gui`）。

以下是它退役前的原始说明，一字未改 —— Dreg_verify 的 PySide6 图形界面（含 debug 辅助 + 测试项可视化编辑）：
...
运行: python -m dreg_verify.legacy_gui
"""
