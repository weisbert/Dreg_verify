...
class AnalysisWorkerProto(Protocol):
    ...
    def start(self, provider: "ProviderProto", request: AnalysisRequest) -> None: ...
...
class ProviderProto(Protocol):
    ...
    def render_sv(self, only, mode, max_tests, exhaustive, edited, comments=False, sv_summary=False,
                  owner_in_msg=False, scope="all", sig_cov=None, form_cov=None) -> Tuple[str, dict]: ...
